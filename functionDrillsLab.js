...
const newEmailCheck = emailCheck('priscilla@gmail.com');
...
const totalFrogs = chocolateFrogs(30);
...
const totalFrogs2 = chocolateFrogs2(32);
console.log(totalFrogs);
